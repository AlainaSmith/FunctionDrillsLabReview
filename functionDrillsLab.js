...
/*
  ...
  nameCheck should check if the name equals 'Steven'. If it does, return 'What is up 
  Steven?'
  If the name parameter is equal to Bryan, return 'Hey Bryan!'
  If the name parameter is anything else, return 'Cool name, NAMEPARAM' 
  (with NAMEPARAM being the value of the name parameter being passed in).
  Create a variable called 'nameGreeting' and set it 
  equal to your function invoked (called) passing in an argument.
*/
...
const nameGreeting = nameCheck('kelly')
...
/*
  ...
  Otherwise, you should return the string 'you need to evaluate your favorite color 
  choice'
...
const faveColorFinder = (color) => {
  if (color === "red"){
    ...
    return 'you need to evaluate ur fav color'
  }
}
...
const theEliminator = (contestants[i], loser) => {
...
/*
  ...
  However, you can't really go to a store and by 1.333 products. You would just be
   able to purchase 1 product. Re-write the function you used in the previous problem 
   (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke 
...
/*
  ...
  order. The function should return true, if it is sorted in ascending order, false 
  if it is not. Create a variable, `arrayIsAscending` and set it equal to your function 
  inoked. Use the sample array to test this function.
*/

const listOfNum = (arr[i]) => {
  if (arr[i] )
  return true
} else {
  return false
...
arrayIsAscending = listOfNum(sampleArray[i])
